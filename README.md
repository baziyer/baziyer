...
- **Vulcan** · energy modelling in Rust, WebAssembly and TypeScript
- --> **Community** · a visual editor that enables creating input files for the Home Energy Model in 2D orthogonal or 3D elevation views. Vulcan Community supports imports of CAD files in IFC4 format, tracing floor-plans, validation of inputs, and comparison with SAP inputs / outputs.
